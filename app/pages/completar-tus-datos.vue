<template>
  <div class="w-full flex flex-col justify-start lg:justify-center items-center lg:h-[calc(100vh-172px)]">
    <div class="max-w-[525px] lg:bg-neutral-white lg:rounded-xl lg:shadow-sm lg:px-10 lg:py-10 lg:border lg:border-neutral-grayBg">
